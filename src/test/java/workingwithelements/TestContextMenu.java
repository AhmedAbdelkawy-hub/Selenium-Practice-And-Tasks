...
public class TestContextMenu {
	 ...
	 * System.getProperty("user.dir")+"\\Sources\\chromedriver.exe"); driver = new
	 * ChromeDriver(); driver.navigate().to(
	 * "http://swisnl.github.io/jQuery-contextMenu/demo/accesskeys.html");
